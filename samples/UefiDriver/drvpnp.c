...
EFI_STATUS EFIAPI SampleDriverSupported(IN EFI_DRIVER_BINDING_PROTOCOL *This, IN EFI_HANDLE Controller, IN EFI_DEVICE_PATH_PROTOCOL *RemainingDevicePath) {
...
EFI_STATUS EFIAPI SampleDriverStop(IN EFI_DRIVER_BINDING_PROTOCOL* This, IN EFI_HANDLE Controller,
...
EFI_STATUS EFIAPI SampleDriverStart(IN EFI_DRIVER_BINDING_PROTOCOL *This, IN EFI_HANDLE Controller, IN EFI_DEVICE_PATH_PROTOCOL *RemainingDevicePath) {
	EFI_STATUS efiStatus;
